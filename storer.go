...
var _ TimeWheel = (*Storer)(nil)

func NewStorer(subWheel TimeWheel, wheelSize int) *Storer {
...
func (tw *Storer) Add(t Task) error {
	if tw.ticking != 1 {
...
func (tw *Storer) Interval() time.Duration {
	return tw.interval
}

func (tw *Storer) Start() {
	tw.mu <- true
